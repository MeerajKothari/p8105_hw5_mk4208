...
The following plots shows the average estimate of β1 estimate on the y-axis and the true value of β1 on the x-axis. The second plot shows the average estimate of β1 estimate **only in samples for which the null was rejected** on the y-axis and the true value of β1 on the x-axis. 

Based on this, we can see that the sample average of β1 estimate across the tests for which the null is rejected is not equal to the true value of β1. This is because as the effect size increases, power also increase. Hence, we can see that the sample beta deviates from the true beta among the samples for which the null was rejected.  
